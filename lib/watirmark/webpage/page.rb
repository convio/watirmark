...
module KeywordMethods; attr_accessor :keyword, :radio_map ;end
...
class Page
  ...
  class << self
    ...
    def keyword(method_sym, map=nil, &block)
      ...
      if map.is_a? Hash
        map = Watirmark::WebPageExtensions::RadioMap.new map
      end
...
class ProcessPage
  ...
  class << self
    def navigate_method_default=(proc); @@navigate_method_default = proc;  end
    def submit_method_default=(proc); @@submit_method_default = proc;  end
    def active_page_method_default=(proc); @@active_page_method_default = proc;  end
    def navigate_method_default; @@navigate_method_default;  end
    def submit_method_default; @@submit_method_default;  end
    def active_page_method_default; @@active_page_method_default;  end
  end
