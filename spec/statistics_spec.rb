...
describe 'Watirmark Statistics' do
  ...
  specify 'Finding Elements' do
    ...
    expect(@each_stats.found_elements.size).to be == 14
  ...
  specify 'Collects multiple sets of statistics simultaneously' do
    ...
    expect(@newer_stats.found_elements.size).to be == 14
    expect(@new_stats.found_elements.size).to be == 28
    expect(@each_stats.found_elements.size).to be == 42
